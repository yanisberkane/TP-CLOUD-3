...
// J'ai laisser cette fonction la car je voulais m'assurer de la s�paration des concern, sinon j'aurais ajout� de la logique business dans le data layer.
app.MapPost("/Posts/Add", async (IRepositoryAPI repo,  IFormFile Image, HttpRequest request, BlobController blob, ServiceBusController sb) =>
{
    try
    {
        ...
        // Si cr�er, envoyer dans les services bus
